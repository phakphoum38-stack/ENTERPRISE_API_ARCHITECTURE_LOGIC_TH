...
class NativeSkillRuntime(CoreReadSkillHandlers, CoreOpsSkillHandlers, LegacyReadSkillHandlers, LegacyOpsSkillHandlers):
    ...
    def __init__(self, registry: UnifiedSkillRegistry | None = None) -> None:
        ...
        self._handlers = {
            ...
            "analysis": self._owner_analysis,
            "planning": self._owner_planning,
            "coding": self._owner_coding,
            "research": self._owner_research,
            "data": self._owner_data,
            "documents": self._owner_documents,
            "automation": self._owner_automation,
            "memory": self._owner_memory,
            "security": self._owner_security,
            "quality": self._owner_quality,
