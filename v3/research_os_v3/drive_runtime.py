...
class DriveToolRuntimeAdapter:
    """Execute verified owner-provided Drive tool packages from a local mirror."""
    ...
    def execute(self, arguments: dict[str, object]) -> dict[str, object]:
        ...
        package = self._load_manifest(package_root / self.MANIFEST)
        ...
        try:
            result: object = json.loads(stdout) if stdout.strip() else None
