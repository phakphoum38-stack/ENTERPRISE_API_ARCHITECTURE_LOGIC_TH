...
# Ordered by logical capacity. BrainCore always picks the smallest safe profile.
# Capacity is a planning ceiling only: workers are never eagerly pre-spawned.
...
class Workload:
    ...
    def normalized_demand(self) -> int:
        ...
        parallel_multiplier = 1 if self.parallelism <= 1 else min(self.parallelism, 10)
