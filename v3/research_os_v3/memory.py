...
class MemoryStore:
    """Simple durable per-user memory with deterministic local retrieval.

    This intentionally avoids hidden self-modification. Memory is explicit,
    user-scoped, append-only at the storage layer, and searchable by lexical
    overlap so the V3 runtime remains deterministic and offline-capable.
    """
