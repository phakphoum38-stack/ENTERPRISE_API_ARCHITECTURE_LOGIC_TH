...
Future<void> main() async {
  ...
  final profileId = Platform.environment['RESEARCH_OS_OWNER_PROFILE'] ?? 'default';
  final sessionId = Platform.environment['RESEARCH_OS_OWNER_SESSION'] ?? 'desktop';
  final baseUrl = Platform.environment['RESEARCH_OS_FRIEND_URL'] ?? 'http://127.0.0.1:8790';
