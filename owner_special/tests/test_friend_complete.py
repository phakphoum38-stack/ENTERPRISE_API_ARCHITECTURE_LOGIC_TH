...
class FriendCompleteTests(unittest.TestCase):
    ...
    def test_evidence_redacts_credential_like_values(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            fake_credential = "s" + "k-" + "abcdefghijklmnopqrstuv"
            runtime.orchestrator.evidence.record(owner_id="phakphum", profile_id="default", session_id="default", event="redaction-test", data={"value": fake_credential})
