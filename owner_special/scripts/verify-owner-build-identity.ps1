...
param(
  ...
  [string]$ExpectedFileName = 'research_os_owner_special.exe',
  [string]$ExpectedProductName = 'research_os_owner_special',
...
if (-not (Test-Path $ExpectedManifestPath -PathType Leaf)) { Fail "Owner manifest missing: $ExpectedManifestPath" }
