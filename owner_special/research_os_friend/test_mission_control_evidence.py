...
class _Run:
    def __init__(self, run_id: str, owner_id: str, status: str, evidence_id: str | None) -> None:
        self.run_id = run_id
        self.owner_id = owner_id
        self.status = type("Status", (), {"value": status})()
        self.response = type("Response", (), {"evidence_id": evidence_id})() if evidence_id else None
