...
def model_version_drift() -> bool:
    return _semantic("owner_special/research_os_friend/aeos_temporal_freshness.py", constructs=("version", "fresh", "stale"))
...
def assurance_coverage() -> bool:
    return _semantic("owner_special/research_os_friend/aeos_assurance_check_fabric.py", constructs=("coverage", "register", "ordered"))
def blind_spot_discovery() -> bool:
    return _semantic("owner_special/research_os_friend/aeos_negative_space_scanner.py", constructs=("UNKNOWN", "missing", "scan"))
