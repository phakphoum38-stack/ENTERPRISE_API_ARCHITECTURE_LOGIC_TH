...
- `current/` ใช้เก็บเอกสารของเวอร์ชันที่กำลังพัฒนา
...
ANEF เป็น Framework ที่เป็นกลางต่อภาษา แพลตฟอร์ม ผู้ให้บริการ AI ระบบฐานข้อมูล และ Cloud Provider โดยใช้เอกสารและสถาปัตยกรรมเป็นแหล่งอ้างอิงหลัก
