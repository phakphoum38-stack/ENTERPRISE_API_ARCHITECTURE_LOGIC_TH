...
| System Spine / Registry | `current/RESEARCH_OS_PLATFORM_GOVERNANCE_CONTRACT.json`, `current/RESEARCH_OS_PLATFORM_COMPONENT_INVENTORY.json`, `current/PLATFORM_VIRTUAL_WORKSPACE_REGISTRY.json` | ACTIVE |
...
| Contract Evolution | existing Platform contract/versioning sources | ACTIVE |
...
| Drift Detection | canonical-source scan in `tools/platform_self_reconciliation.py` | ACTIVE |
