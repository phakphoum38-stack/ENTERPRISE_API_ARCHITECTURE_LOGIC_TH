...
def main() -> int:
    ...
    manifest = {"version": 1, "immutable": True, "workflow": args.workflow, "run_id": str(args.run_id), "commit": commit, "generated_at_utc": datetime.now(timezone.utc).isoformat(), "evidence": files, **metadata}
