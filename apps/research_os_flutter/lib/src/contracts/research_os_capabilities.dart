/// Stable capability contracts shared by the canonical Control Center.
///
/// Implementations stay behind adapters. UI code must depend on these
/// interfaces rather than concrete HTTP clients or platform runners.
library;
...
/// Composite contract consumed by canonical Control Center features.
///
/// A concrete adapter can implement only the capabilities it owns and be
/// composed at the application boundary. This keeps platform/runtime
/// implementations out of presentation widgets.
