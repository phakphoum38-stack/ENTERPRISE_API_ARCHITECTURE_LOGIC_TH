            ...
            SizedBox(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(
                    height: 430,
                    child: DesignStudioPanel(apiClient: widget.apiClient),
                  ),
                ],
              ),
            ),
    ...
    return Material(
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            Row(children: <Widget>[
              Expanded(child: Text('Context Inspector', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800))),
              IconButton(
            ...
            const Wrap(spacing: 8, runSpacing: 8, children: <Widget>[Chip(label: Text('GUI Designer')), Chip(label: Text('Developer'))]),
            const SizedBox(height: 14),
              ...
              child: Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                  Row(children: <Widget>[
                    ...
                    Expanded(child: Text('$scale ORCHESTRATOR', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w800))),
            ...
            const _EvidenceRow(icon: Icons.design_services_outlined, title: 'Design created', detail: 'GUI Designer • implementation handoff'),
            const _EvidenceRow(icon: Icons.fact_check_outlined, title: 'Regression', detail: 'Runtime result appears after verification'),
            if (error != null) ...<Widget>[const SizedBox(height: 12), Text(error!, style: TextStyle(color: scheme.error))],
          ],
        ),
      ),
    );
...
class _EvidenceRow extends StatelessWidget {
  ...
  final String detail;
  @override
  Widget build(BuildContext context) => ListTile(contentPadding: EdgeInsets.zero, leading: Icon(icon), title: Text(title), subtitle: Text(detail));
}
