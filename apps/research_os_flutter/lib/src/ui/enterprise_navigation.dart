...
const researchNavigationItems = <ResearchNavItem>[
  ...
  ResearchNavItem('Workspace', 'Agent Center', Icons.smart_toy_outlined, 2, capabilityId: 'agent', destinationId: 'agent_center'),
  ...
  ResearchNavItem('Connections', 'GitHub', Icons.account_tree_outlined, 5, capabilityId: 'github', destinationId: 'github'),
  ResearchNavItem('Connections', 'Google Workspace', Icons.apps_outlined, 6, destinationId: 'google_workspace'),
  ResearchNavItem('Connections', 'Friend Connect', Icons.support_agent_outlined, 13, capabilityId: 'friend', destinationId: 'friend_connect'),
  ...
  ResearchNavItem('Workspace', 'Workflows', Icons.account_tree_outlined, 15, capabilityId: 'factory_v3', destinationId: 'workflows'),
  ResearchNavItem(
    'Control',
    'Control Center',
    Icons.tune_outlined,
